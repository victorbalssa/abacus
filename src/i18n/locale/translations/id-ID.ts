export default {
  ...
  OAUTH_fireflyInstanceHelpLabel: "tanpa akhiran '/'",
  OAUTH_fireflyPlaceholder: "Firefly III backend URL (tanpa akhiran '/')",
  OAUTH_oauth_clientId: 'Oauth Client ID',
  OAUTH_oauth_client_secret: 'Oauth Client Secret',
  OAUTH_secrets_help_message: 'Semua kredensial berada dalam penyimpanan aman iOS.',
  OAUTH_set_redirect: 'atur redirect URI ke:',
  OAUTH_need_help: 'Butuh Bantuan?',
